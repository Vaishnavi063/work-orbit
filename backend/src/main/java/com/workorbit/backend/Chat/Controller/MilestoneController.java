 ...
 * status updates, and progress tracking within contract chats.
 */
@RestController
...
public class MilestoneController {
    ...
    /**
     * Manually triggers milestone progress tracking update.
     * This endpoint can be used for administrative purposes or scheduled tasks.
     * 
     * @return success response
     */
