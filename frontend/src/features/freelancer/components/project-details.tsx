import { Calendar, Tag, IndianRupee, ArrowLeftIcon } from "lucide-react";
...
const ProjectDetails = () => {
  ...
  return (
    <>
      <div className="container max-w-7xl mx-auto sm:px-3 lg:px-8 space-y-6">
        <header className="p-4 flex items-center justify-between bg-slate-50 rounded-lg shadow-sm border">
          <Button
            variant="outline"
            size="sm"
            onClick={() => navigate(-1)}
