...
const Hero = () => {
  return (
    <div className="relative pt-4 pb-8 sm:pb-16 sm:pt-10 px-4 sm:px-8 mx-auto container">
      <div className="relative flex items-center justify-center flex-col sm:block sm:container z-[10]">
        ...
        <div className="hidden sm:flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-4 mt-4 text-sm">
